...
from metadata_vision.schemas.plotstate import PlotStateMetadata, SoilType, WeatherConditions, SurfaceLayer
...
def create_dummy_data():
    ...
    dummy_crop = CropMetadata(
        ...
        cropTiming=CropTiming(
            type=CropTimingType.PLANTING_DATE,
            date=datetime.datetime(2026,1,10))
    )
